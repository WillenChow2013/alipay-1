...
public class CommonUtil {
	...
	public static String strYuanToFen(Object yuan) {
		...
		return String.valueOf(Integer.parseInt(new java.text.DecimalFormat("0").format(moneyI * 100)));
	}
	 ...
	 * @param msgLenType 报文长度是否包含本身，0不包含 1包含
	...
	public static int readInt32(byte[] dataBuffer) {
		int pos = 0;
		return (dataBuffer[pos] & 255) + ((dataBuffer[pos + 1] & 255) << 8) + ((dataBuffer[pos + 2] & 255) << 16)
	...
	public static String replaceStr(String regex, String source, Map<String, Object> param) throws Exception {
